	...
	def static toJava(Game game)'''
		...
		public class GameOfLife extends JFrame implements ActionListener {
			...
			public static void main(String[] args) {
				...
				//game.setSize(new Dimension((width + 2) * BLOCK_SIZE, (height + 2) * BLOCK_SIZE));
			...
			private class GameBoard extends JPanel implements ComponentListener, MouseListener, MouseMotionListener, Runnable {
				private static final long serialVersionUID = 1L;
				private Dimension d_gameBoardSize = new Dimension(«game.field.width», «game.field.height»);
				...
				public GameBoard() {
					...
					updateArraySize();
					setPreferredSize(new Dimension((«game.field.width» + 2) * BLOCK_SIZE, («game.field.height» + 2) * BLOCK_SIZE));
				}
