...
void main_task(intptr_t unused) {
    ...
    while(1)
    {
        ...
        if(ultrasonic <=30) //object detected, try avoiding it
        {
...
void bt_task(intptr_t unused) {
    ...
    while ((c = fgetc(bt_con))) {
        ...
        {
                    yellow = 1;
                    cycle_print((char*)"Yellow received!");
                    ev3_speaker_play_tone(250, 200);
        } else if(!blue && c == 'b')
        {
                    blue = 1;
